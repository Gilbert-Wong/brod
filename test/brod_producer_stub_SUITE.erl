%%%=============================================================================
%%% @doc
%%% @copyright 2017-2018 Klarna Bank AB (publ)
%%% @end
%%% ============================================================================
...
t_no_required_acks(Config) when is_list(Config) ->
  ...
  meck:expect(brod_kafka_request, produce,
              fun(_Vsn, <<"topic">>, 0, KvList, 0, _, no_compression) ->
                  ...
                  #kpro_req{api = produce, msg = <<"fake-produce-request">>}
              end),
  meck:expect(kpro, request_async,
              fun(_Pid, #kpro_req{api = produce,
                                  msg = <<"fake-produce-request">>}) -> ok end),
